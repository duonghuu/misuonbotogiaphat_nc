<?php
	...
	$ten_input=sanitize($_POST['ten']);
	$diachi_input=sanitize($_POST['diachi']);
	$dienthoai_input=sanitize($_POST['dienthoai']);
	$email_input=sanitize($_POST['email']);
	$noidung_input=sanitize($_POST['noidung']);
	$phuongthuc_input=sanitize($_POST['phuongthuc']);
	$tinhthanh=sanitize($_POST['tinhthanh']);
	$phivanchuyen=sanitize($_POST['phivanchuyen']);
	$quanhuyen=sanitize($_POST['quanhuyen']);
