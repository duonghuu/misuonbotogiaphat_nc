...
?>
    ...
    <a href="<?=$rows_qcphai['mota']?>" target="_blank"><img src="<?=_upload_hinhanh_l.$rows_qcphai['photo']?>" width="150" /></a><br/>
	<?php } ?>
    </div>
    
    <div id="divAdLeft" style="DISPLAY: none; POSITION: absolute; TOP: 0px">
    <?php while($rows_qctrai=mysql_fetch_assoc($result_qctrai)) { ?>
    <a href="<?=$rows_qctrai['mota']?>" target="_blank"><img src="<?=_upload_hinhanh_l.$rows_qctrai['photo']?>" width="150" /></a><br/>
	<?php } ?>     
    </div>
    <script>
