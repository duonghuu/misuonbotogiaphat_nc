<div class="bg-tieudesanpham"><h3><?= _dichvu?></h3></div>
<div class="product-all">   
   ...
   <div class="othernews">
    ...
    <li><a href="dich-vu/<?=$tinkhac['tenkhongdau']?>-<?=$tinkhac['id']?>.html" ><?=$tinkhac['ten_'.$lang]?></a> <font color="#666">(<?=make_date($tinkhac['ngaytao'])?>)</font></li>
    <?php }?>
         </ul>
  </div>
</div>