<?php  if(!defined('_source')) die("Error");
		...
		if($id!=''){
			...
			$sql = "select ten_$lang,ngaytao,id,tenkhongdau,thumb from #_baiviet where hienthi=1 and id !='".$row_detail['id']."' and type='".$type_bar."' order by stt,ngaytao desc limit 0,6";
			$d->query($sql);
			...
			$d->reset();
			$sql = "select id,ten_$lang,tenkhongdau,title,keywords,description from #_baiviet_list where hienthi=1 and type='".$type_bar."' and tenkhongdau='".$idl."'";
			$d->query($sql);
			$row_detail = $d->fetch_array();
			...
			$sql = "select ten_$lang,id,photo,mota_$lang,tenkhongdau from $where $limit";
			$d->query($sql);
			$tintuc = $d->result_array();
			...
			$d->reset();
			$sql = "select id,ten_$lang,tenkhongdau,title,keywords,description from #_baiviet_cat where hienthi=1 and type='".$type_bar."' and tenkhongdau='".$idc."'";
			$d->query($sql);
			$row_detail = $d->fetch_array();
			...
			$sql = "select ten_$lang,id,photo,mota_$lang,tenkhongdau,thumb from $where $limit";
			$d->query($sql);
			$tintuc = $d->result_array();
			...
			$d->reset();
			$sql = "select id,ten_$lang,tenkhongdau,title,keywords,description from #_baiviet_item where hienthi=1 and type='".$type_bar."' and tenkhongdau='".$idi."'";
			$d->query($sql);
			$row_detail = $d->fetch_array();
			...
			$sql = "select ten_$lang,photo,tenkhongdau,id,ngaytao,mota_$lang,photo,thumb from $where $limit";
			$d->query($sql);
			$tintuc = $d->result_array();
