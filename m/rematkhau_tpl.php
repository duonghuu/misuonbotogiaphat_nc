...
<div class="ui-corner-all custom-corners">
	<div class="ui-bar ui-bar-a"><h3>Quên mật khẩu</h3></div> 
...
<article id="info" class="col-lg-12 col-md-12 col-sm-12 col-xx-12 col-xs-12">
		...
		<form method="post" name="frm" action="quen-mat-khau.html" style="max-width:520px; margin:auto;">
			...
			<button type="submit" class="btn btn-primary dangbai" data-toggle="button" aria-pressed="false" autocomplete="off" onclick="js_submit()">Gửi Email</button>
