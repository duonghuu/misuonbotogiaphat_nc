...
<div class="ui-corner-all custom-corners">
	<div class="ui-bar ui-bar-a"><h3><?=_donhang?></h3></div>
	<div class="ui-body ui-body-a">
	<div class="info-content">
		<div class="text" style="width: 100%;padding: 10px 0px;">
...
<div class="ui-corner-all custom-corners">
	<div class="ui-bar ui-bar-a"><h3><?=_khachhang?></h3></div>
	<div class="ui-body ui-body-a"
			...
			<form method="post" name="frm_order" action="" enctype="multipart/form-data" onsubmit="return check();">
				<table width="100%" cellpadding="5" cellspacing="5" border="0" class="tablelienhe">
					<tr>
					  ...
					  <td><input name="ten" id="ten" class="input" value="<?=$_SESSION['logging']['name']?>" /></td>
					</tr>
					<tr>
					  <td><b><?=_phone?></b><span>*</span></td>
					  <td><input name="dienthoai" id="dienthoai" class="input" value="<?=$_SESSION['logging']['dienthoai']?>" onkeypress="return validate();" /></td>
					</tr>
					<tr>
					  <td><b><?=_address?></b><span>*</span></td>
					  <td><input  name="diachi"  id="diachi" class="input"  value="<?=$_SESSION['logging']['diachi']?>"/></td>
					</tr>
					<tr>
					  <td><b>E-mail</b><span>*</span></td>
					  <td><input name="email" id="email" class="input"  value="<?=$_SESSION['logging']['email']?>"/></td>
					</tr>
					<tr>
					  <td><b><?=_noidung?></b></td>
					  <td><textarea name="noidung" id="noidung" class="noidung"  ><?=$_POST['noidung']?></textarea></td>
					</tr>
				</table>
