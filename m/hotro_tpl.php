  ...
  <div class="ui-body ui-body-a">
    ...
    <?php for($i=0; $i<count($tintuc); $i++){?>
      <div class="box-news">
        ...
        <p class="news-img"><a href="ho-tro-khach-hang/<?=$tintuc[$i]['tenkhongdau']?>-<?=$tintuc[$i]['id']?>.html"><img src="<?=_upload_tintuc_l.$tintuc[$i]['thumb']?>" /></a></p>
        <h3 class="news-name"><a href="ho-tro-khach-hang/<?=$tintuc[$i]['tenkhongdau']?>-<?=$tintuc[$i]['id']?>.html"><?=$tintuc[$i]['ten']?></a></h3>
