    ...
    <div class="widget">
		...
		<div class="title chonngonngu">
			<ul>
				...
				<li><a href="cn" class="tipS validate[required]" title="Chọn tiếng trung "><img src="./images/icon-cn.png" alt="" class="tienganh" />Tiếng Trung</a></li>
			</ul>
		</div>	
		...
		<div class="formRow lang_hidden lang_cn">
			<label>Công Ty (Tiếng trung)</label>
			<div class="formRight">
...
<!-- 		<div class="formRow lang_hidden lang_vi active">
		...
		<div class="formRow">
			<label>Fax</label>
			<div class="formRight">
				<input type="text" value="<?=@$item['fax']?>" name="fax" title="Nhập Fax" class="tipS" />
			</div>
			<div class="clear"></div>
		</div>
		<div class="formRow">
		...
		<div class="formRow">
			<label>Tọa độ</label>
			<div class="formRight">
				<input type="text" value="<?=@$item['toado']?>" name="toado" title="Nhập tọa độ vị trí" class="tipS" />
			</div>
			<div class="clear"></div>
		</div>	
		...
		<div class="formRow">
			...
			<div class="formRight">
				<input type="text" value="<?=@$item['sang']?>" name="sang" title="Nhập thời gian" class="tipS" />
			</div>
			<div class="clear"></div>
		</div>	
		<div class="formRow">
			...
			<div class="formRight">
				<input type="text" value="<?=@$item['chieu']?>" name="chieu" title="Nhập thời gian" class="tipS" />
			</div>
			<div class="clear"></div>
		</div>	
		<div class="formRow">
		...
		<div class="formRow">
			<label>Twitter</label>
			<div class="formRight">
				<input type="text" value="<?=@$item['twitter']?>" name="twitter" title="Nhập link fanpage twitter" class="tipS" />
			</div>
			<div class="clear"></div>
		</div> 
		<div class="formRow">
			<label>Google</label>
			<div class="formRight">
				<input type="text" value="<?=@$item['google']?>" name="google" title="Nhập link fanpage google" class="tipS" />
			</div>
			<div class="clear"></div>
		</div> 
		<div class="formRow">
			...
			<div class="formRight">
				<textarea rows="8" cols="" title="iframemap" class="tipS" name="iframemap"><?=@$item['iframemap']?></textarea>
			</div>
			<div class="clear"></div>
		</div>	
		<!--
		<div class="formRow">
			<label>Youtube</label>
			<div class="formRight">
				<input type="text" value="<?=@$item['youtube']?>" name="youtube" title="Nhập link fanpage youtube" class="tipS" />
			</div>
			<div class="clear"></div>
		</div> -->
		<div class="formRow">
			...
			<div class="formRight">
                <input type="text" name="sanpham" title="Nhập số sản phẩm trang chủ" id="sanpham" class="tipS validate[required]" value="<?=@$item['sanpham']?>" />
			</div>
			<div class="clear"></div>
		</div>
 ...
 -->
    ...
    <div class="widget">
		...
		<div class="formRow">
			<label>Scriptcode header:</label>
			<div class="formRight">
				<textarea rows="8" cols="" title="Scriptcodeheader" class="tipS" name="scriptcodeheader"><?=@$item['scriptcodeheader']?></textarea>
			</div>
			<div class="clear"></div>
		</div>	

		<div class="formRow">
			<label>Scriptcode body:</label>
			<div class="formRight">
				<textarea rows="8" cols="" title="Scriptcodebody" class="tipS" name="scriptcode"><?=@$item['scriptcodebody']?></textarea>
			</div>
			<div class="clear"></div>
		</div>
        <div class="formRow">
