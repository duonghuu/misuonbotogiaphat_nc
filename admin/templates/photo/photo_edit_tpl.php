...
<form name="supplier" id="validate" class="form" action="index.php?com=photo&act=save_photo<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" method="post" enctype="multipart/form-data">
	<div class="widget">
        ...
        <div class="formRow lang_hidden lang_vi active">
            <label>Mô tả</label>
            <div class="ck_editor">
                <textarea rows="4" id="mota_vi" cols="" title="Nhập mô tả . " class="tipS" name="mota_vi"><?=@$item['mota_vi']?></textarea>
            </div>
            <div class="clear"></div>
        </div>
        ...
        <div class="formRow lang_hidden lang_en">
            ...
            <div class="ck_editor">
                <textarea rows="4" id="mota_en" cols="" title="Nhập mô tả . " class="tipS" name="mota_en"><?=@$item['mota_en']?></textarea>
            </div>
            <div class="clear"></div>
        </div>
        <?php }?>		
