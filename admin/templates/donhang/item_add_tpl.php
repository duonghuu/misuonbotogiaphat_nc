...
<tbody>
   ...
   <td align="center"><img src="<?=_upload_product.$chitietdonhang[$i]['photo']?>" height="70"  /></td>
   <?php /* <td align="center"><?=number_format($chitietdonhang[$i]['giacu'],0, ',', '.')?>&nbsp;VNĐ</td> */?>
   <td align="center">
