...
<table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
	...
	<tr style="text-align:center">
        ...
        <td class="sortCol"><div>Thời gian<span></span></div></td>
        <td class="sortCol"><div>Số lượng<span></span></div></td>
        <td class="sortCol"><div>Ngày tháng<span></span></div></td>
	...
	<tr style="text-align:center">
        ...
        <td style="width:20%;" align="center"><b><?=$items[$i]['thoigian']?></b></td>
        <td style="width:20%;" align="center"><b><?=$items[$i]['soluong']?></b></td>
        <td style="width:30%;" align="center"><b><?=$items[$i]['ngaythang']?></b></td>
