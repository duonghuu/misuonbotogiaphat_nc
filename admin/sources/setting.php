...
function save_gioithieu(){
	...
	$data['iframemap'] = magic_quote($_POST['iframemap']);
	$data['scriptcodeheader'] = magic_quote($_POST['scriptcodeheader']);
	$data['scriptcodebody'] = magic_quote($_POST['scriptcodebody']);
